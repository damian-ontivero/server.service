"""Abstract class defines the Operating System service interface."""
...
class OperatingSystemAbstractService:
    """Abstract class defines the Operating System service interface."""
    ...
    @abstractmethod
    def add_one(
        cls, server_dto: OperatingSystemCreate, access_token: str | None = None
    ) -> OperatingSystem:
        """Adds an entity.

        Args:
            server_dto (`OperatingSystemCreate`): Entity to add.
            access_token (`str` | `None`, `optional`): Access token. Defaults to `None`.
    ...
    def update_one(
        cls,
        id_: int,
        server_dto: OperatingSystemUpdate,
        access_token: str | None = None,
    ) -> OperatingSystem:
        """Updates an entity.
        ...
        Args:
            id_ (`int`): Entity id.
            server_dto (`OperatingSystemUpdate`): Entity to update.
            access_token (`str` | `None`, `optional`): Access token. Defaults to `None`.
