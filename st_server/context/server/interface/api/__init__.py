...
from st_server.context.server.interface.api.application.router import (
    router as application_router,
)
from st_server.context.server.interface.api.connection_type.router import (
    router as connection_type_router,
)
from st_server.context.server.interface.api.environment.router import (
    router as environment_router,
)
from st_server.context.server.interface.api.operating_system.router import (
    router as operating_system_router,
)
from st_server.context.server.interface.api.server.router import (
